...
/**
 * Zenbooker MCP Server implementation
 * 
...
export class ZenbookerMCP extends McpAgent {
	...
	/**
	 * Initializes all MCP tools for the Zenbooker API
	 * 
	 * This method defines 13 comprehensive tools organized by resource type:
